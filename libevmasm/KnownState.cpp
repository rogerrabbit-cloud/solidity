...
ExpressionClasses::Id KnownState::stackElement(int _stackHeight, yul::DebugData::Ptr _debugData)
{
...
KnownState::Id KnownState::relativeStackElement(int _stackOffset, yul::DebugData::Ptr _debugData)
{
...
ExpressionClasses::Id KnownState::loadFromStorage(Id _slot, yul::DebugData::Ptr _debugData)
{
...
KnownState::StoreOperation KnownState::storeInMemory(Id _slot, Id _value, yul::DebugData::Ptr _debugData)
{
...
ExpressionClasses::Id KnownState::loadFromMemory(Id _slot, yul::DebugData::Ptr _debugData)
{
...
KnownState::Id KnownState::tagUnion(std::set<u256> _tags)
{
	...
	{
		Id id = m_expressionClasses->newClass(yul::DebugData::create());
