...
public:
	...
	AssemblyItem toAssemblyItem(yul::DebugData::Ptr const& _debugData) const;
...
struct ExpressionTemplate
{
	using Expression = ExpressionClasses::Expression;
	using Id = ExpressionClasses::Id;
	explicit ExpressionTemplate(Pattern const& _pattern, yul::DebugData::Ptr const& _debugData);
	std::string toString() const;
	bool hasId = false;
